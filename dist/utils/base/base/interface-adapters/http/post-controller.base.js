...
exports.HttpPostControllerBase = void 0;
const use_cases_1 = require("../../../use-cases");
const common_1 = require("@nestjs/common");
const oxide_ts_1 = require("oxide.ts");
class HttpPostControllerBase {
    ...
    execute(httpRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, oxide_ts_1.match)(result, {
                ...
                Err: (exception) => {
                    if (exception instanceof use_cases_1.UseCaseCommandValidationExceptions) {
...
], HttpPostControllerBase.prototype, "execute", null);
exports.HttpPostControllerBase = HttpPostControllerBase;
//# sourceMappingURL=post-controller.base.js.map