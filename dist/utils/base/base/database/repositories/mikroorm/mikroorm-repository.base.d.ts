...
export declare abstract class MikroOrmRepositoryBase<DomainModel extends AbstractAggregateRoot<any>, DomainModelDetails, OrmModel extends MikroOrmModelBase> implements RepositoryPort<DomainModel, DomainModelDetails> {
    ...
    protected readonly queryMapper: MikroOrmQueryMapper<DomainModelDetails, OrmModel>;
    protected readonly mikroEntityName: MikroOrmModelConstructor<OrmModel>;
    protected readonly logger: Logger;
    constructor(entityManager: EntityManager, mapper: MikroOrmMapperBase<DomainModel, DomainModelDetails, OrmModel>, queryMapper: MikroOrmQueryMapper<DomainModelDetails, OrmModel>, mikroEntityName: MikroOrmModelConstructor<OrmModel>, logger: Logger);
