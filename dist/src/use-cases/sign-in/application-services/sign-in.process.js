...
let SignInProcess = class SignInProcess extends use_cases_1.ProcessBase {
    enforceBusinessRules(command) {
        return __awaiter(this, void 0, void 0, function* () {
            const { email } = command;
            yield this.userBusinessEnforcer.userMustHaveRegistered(email);
        });
    }
    ...
    constructor(passwordManagementService, jwtService, userBusinessEnforcer) {
        super({
...
SignInProcess = __decorate([
    ...
    __metadata("design:paramtypes", [_domain_services_1.PasswordManagementDomainService,
        jwt_1.JwtService,
