...
let RegisterAdminProcess = class RegisterAdminProcess extends use_cases_1.ProcessBase {
    ...
    constructor(userManagementService, userRegistrationService, userBusinessEnforcer) {
        super({
