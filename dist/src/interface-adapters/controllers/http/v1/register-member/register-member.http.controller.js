...
let V1RegisterMemberHttpController = class V1RegisterMemberHttpController extends http_1.HttpPostControllerBase {
    ...
    createDto(httpRequest) {
        return new dtos_1.RegisterMemberRequestDto(httpRequest);
    }
    createHttpResponse(response) {
        return new register_member_http_response_1.V1RegisterMemberHttpResponse(response);
    }
};
__decorate([
