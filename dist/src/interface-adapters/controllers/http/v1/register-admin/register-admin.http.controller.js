...
let V1RegisterAdminHttpController = class V1RegisterAdminHttpController {
    constructor(commandBus) {
        this.commandBus = commandBus;
    }
    execute(dto) {
        return __awaiter(this, void 0, void 0, function* () {
            const command = new dtos_1.RegisterAdminCommand(dto);
            const result = yield this.commandBus.execute(command);
            return (0, oxide_ts_1.match)(result, {
                Ok: (response) => new register_admin_http_response_1.V1RegisterAdminHttpResponse(response),
                Err: (exception) => {
